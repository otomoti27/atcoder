...
func main() {
	...
	backtracking = func(sum, i, k int) {
		...
		backtracking(xor(sum, a[i]), i+1, k-1)
		backtracking(sum, i+1, k)
	}
	...
	// var backtracking func([]int, int, int)
	// backtracking = func(c []int, i, k int) {
	// 	if k == 0 {
	// 		combinations = append(combinations, append([]int{}, c...))
	// 		return
	// 	}
	// 	if i >= n {
	// 		return
	...
	// 	backtracking(append(c, a[i]), i+1, k-1)
	// 	backtracking(c, i+1, k)
	// }

	// backtracking([]int{}, 0, k)
